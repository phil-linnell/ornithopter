...
describe("ornithopter", function () {
  describe(".process()", function () {
    it("should return two keyframes for transform with translateX", function () {
      ...
      const expected = [{step: 0, properties: [{property: 'transform', value: 'translateX(100px)'}]},
    ...
    it("should return two keyframes for transform with rotate", function () {
      ...
      const expected = [{step: 0, properties: [{property: 'transform', value: 'rotate(0deg)'}]},
    ...
    it("should return three keyframes for transform with translateY", function () {
      const actual = process({property: 'transform', value: ['0', '100px', '150px'], fn: 'translateX', totalDuration: '1s'});
      const expected = [{step: 0, properties: [{property: 'transform', value: 'translateX(0)'}]},
